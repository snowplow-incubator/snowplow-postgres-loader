...
import com.snowplowanalytics.snowplow.postgres.loader.shredding.transform.Atomic
import com.snowplowanalytics.snowplow.postgres.loader.shredding.schema
...
case class PgState(tables: Map[ModelGroup, SchemaList]) {
   ...
   */
  private[loader] def check(entity: SchemaKey): TableState = {
