...
object PubsubEnv {
  ...
  private def getPayload[F[_]](record: ConsumerRecord[F, String]): Either[String, String] = record.value.asRight

  private def checkpointer[F[_]]: Pipe[F, ConsumerRecord[F, String], Unit] = _.evalMap(_.ack)
